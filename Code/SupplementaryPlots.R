...
yeast_data_func_vs_nfunc_finer = function(ncores){
  ...
  for(j in 1:10)
  {
    ...
    results = lapply(c(1:length(parents)), function(i){
...
Suppl_Plots = function(){
  ...
  dev.off()
  save(yeast_fvnf_finer, file="../Data/Supplementary/yeast_fvnf_finer.RData")
  ...
  dev.off()
  save(mpal_fvnf_finer, file="../Data/Supplementary/mpal_fvnf_finer.RData")
  ...
  dev.off()
  save(abalone_fvnf_finer, file="../Data/Supplementary/abalone_fvnf_finer.RData")
