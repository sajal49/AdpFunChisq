...
if(0){
  ...
  # 10 x 3 versus 3 x 10 at n = 1000
  res_10x3_3x10_1000 = TableTypeCheck(N = 1000, r = 10, s = 3, ncores = 10)
  save(res_10x3_3x10_1000, file="../Results/TableTypeStudy/res_10x3_3x10_1000.RData")
  
  pdf("../Results/TableTypeStudy/tty_10x3_3x10_1000.pdf", width = 15)
  PlotPatterns(stat_collect = res_10x3_3x10_1000, n = 1000, r = 10, s = 3)
  dev.off()
