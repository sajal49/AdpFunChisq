...
# Ground truth interactions (Yeast_TFTG.csv) are to be put in Data/Yeast/ directory,
# if not available.
...
DiscretizationLvlCheck = function(){
  ...
  yeast_microarray_table_types = ttype
  tab_ttype = table(yeast_microarray_table_types)
  
  cat("\nTable type summary counts: \n")
  print(tab_ttype)
  cat("\nTable type summary proportions: \n")
  print(round((tab_ttype/sum(tab_ttype)), digits = 2))
  save(results,file="../Data/Yeast/Table_Stats.RData")
